 ...
 */ {
        ...
        moveToPosition(settings) {
            return new Promise((resolve, reject)=>{
                ...
                */ TweenMax.to(this.DOM.imgWrap, 0.8, {
                ...
                if (settings.resetImageScale) TweenMax.to(this.DOM.img, 0.8, {
                    ease: Power4.easeInOut,
                    scale: 1
                });
            });
    ...
    class Slideshow {
        ...
        initEvents() {
            ...
            for (let slide of this.slides)slide.DOM.imgWrap.addEventListener('click', ()=>this.clickFn(slide)
            );
            this.resizeFn = ()=>{
                ...
                if (this.isContentOpen) TweenMax.set(this.DOM.deco, {
...
//# sourceMappingURL=work.990ab9df.js.map
