    ...
    return (function t(e, n, i) {
        ...
        2: [
            function(t, e, n) {
                ...
                e.exports = i, i.EventEmitter = i, i.prototype._events = void 0, i.prototype._maxListeners = void 0, i.defaultMaxListeners = 10, i.prototype.setMaxListeners = function(t) {
                    ...
                    }), this._events.newListener && this.emit("newListener", t, r(e.listener) ? e.listener : e), this._events[t] ? o(this._events[t]) ? this._events[t].push(e) : this._events[t] = [
                        this._events[t],
                        e
            ...
            function(t, e, n) {
                ...
                function r() {
                    try {
                        ...
                        for(var e = {
                        }, n = 0; 10 > n; n++)e["_" + String.fromCharCode(n)] = n;
        ...
        7: [
            function(t, e, n) {
                ...
                }, p.on = h, p.addListener = h, p.once = h, p.off = h, p.removeListener = h, p.removeAllListeners = h, p.emit = h, p.binding = function(t) {
            ...
            function(t, e, n) {
                ...
                i.prototype = {
                    ...
                    emit: function(t) {
                        ...
                        }))[t] || []).slice(), i = 0, r = n.length;
                        for(; r > i; i++)n[i].fn.apply(n[i].ctx, e);
                        return this;
                    },
                    off: function(t, e) {
                        var n = this.e || (this.e = {
...
//# sourceMappingURL=index.2409dcc6.js.map
